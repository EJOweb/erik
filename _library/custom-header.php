...
add_action( 'after_setup_theme', 'erik_custom_header_setup', 15 );
 ...
 * @return void
 */
function erik_custom_header_setup() {
	...
	add_theme_support( 
		...
		array(
			...
			'header-text'            => true,
			'uploads'                => true,
			'wp-head-callback'       => 'erik_custom_header_wp_head',
			'admin-head-callback'    => 'erik_custom_header_admin_head',
			'admin-preview-callback' => 'erik_custom_header_admin_preview',
		)
	);
 ...
 * @return void
 */
function erik_custom_header_wp_head() {
 ...
 * @return void
 */
function erik_custom_header_admin_preview() { ?>
 ...
 * @return void
 */
function erik_custom_header_admin_head() {
